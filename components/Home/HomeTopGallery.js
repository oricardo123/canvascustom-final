...
export default function HomeTopGallery() {
  return (
    <>
      <div className="grid grid-cols-1 md:grid-cols-2 mt-20 relative ">
        ...
        <button className="absolute text-black bg-white mt-[32rem] md:mt-[25rem] left-[10%] p-2 mix-blend-screen rounded-md text-lg font-bold z-50">
          View Catalog
        </button>
        <button className="absolute mt-[32rem] md:mt-[25rem] left-[10%] ml-[10rem] p-[0.4rem] outline rounded-md text-lg font-bold z-50">
          Learn More
        </button>
